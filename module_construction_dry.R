...
lnames = load('C:/Users/Maria/Documents/GitHub/Data_Science_Project/Dry-dataInput.RData')
lnames
#############################################################################################################################
...
bwnet_dry = blockwiseModules(datExpr, maxBlockSize = 26000,
                             power = 6, TOMType = "unsigned", minModuleSize = 30,
                             reassignThreshold = 0, mergeCutHeight = 0.25,
                             numericLabels = TRUE,
                             saveTOMs = TRUE,
                             saveTOMFileBase = "dryTOM-blockwise",
                             verbose = 3)

save(bwnet_dry, file='modules_dry.RData')